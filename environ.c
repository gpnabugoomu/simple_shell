 ...
 * @info: potential arguments  maintaining constant function prototype
 *
 * Return: Always 0
 */
...
/**
 * _getenv -  function to get  value of an environ variable
 ...
 * @info: potential arguments maintaining function prototype
 *
 * Return: Always 0
 */
